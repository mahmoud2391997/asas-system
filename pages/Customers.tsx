...
import { Customer, WhatsAppSettings, Branch, Project } from '../types';
...
interface CustomersProps {
    customers: Customer[];
    onSave: (customer: Customer) => Promise<Customer>;
...
const Customers: React.FC<CustomersProps> = ({ customers, onSave, whatsappSettings, branches, onCustomerSelect, PROJECTS }) => {
    ...
    const filteredCustomers = useMemo(() => {
        ...
        if (projectFilter !== 'all') {
            filtered = filtered.filter(customer => customer.projectId === projectFilter);
        }
        ...
        // Exclude cash customer from main list view
        return filtered.filter(c => c.id !== '4');
