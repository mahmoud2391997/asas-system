      ...
      config: {
        ...
        responseSchema: {
          ...
          items: {
            type: Type.OBJECT,
            properties: {
              // FIX: Changed productId type to STRING to match the SuggestedPurchaseOrderItem interface.
...
export async function getFormulaSuggestion(context: FormulaSuggestionContext): Promise<FormulaLine[]> {
    if (!API_KEY) {
        ...
        return new Promise(resolve => setTimeout(() => resolve([
            // FIX: materialId should be a string to match FormulaLine type
            ...
            config: {
                ...
                responseSchema: {
                    ...
                    items: {
                        ...
                        properties: {
                            id: { type: Type.STRING },
                            // FIX: Changed materialId to STRING to match FormulaLine type.
