                ...
                <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                        <div>
                            ...
                            <select value={editableTask.assignedToEmployeeId || ''} onChange={e => handleChange('assignedToEmployeeId', e.target.value ? e.target.value : undefined)} className="form-select">
