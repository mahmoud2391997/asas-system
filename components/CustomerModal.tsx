...
import { Customer, Branch, Project } from '../types';
...
const CustomerModal: React.FC<CustomerModalProps> = ({ customer, onClose, onSave, branches, PROJECTS }) => {
    ...
    const handleChange = (field: keyof Customer, value: string | undefined) => {
                ...
                <div className="modal-body" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => handleChange('branchId', e.target.value || undefined)}
                            className="form-select"
