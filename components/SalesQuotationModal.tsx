...
const SalesQuotationModal: React.FC<SalesQuotationModalProps> = ({ quotation, onClose, onSave, onConvertToInvoice, customers, products }) => {
    ...
    useEffect(() => {
        ...
        setEditableQuote(isCreating ? {
            // FIX: Initialize customerId as a string.
            customerId: '',
    ...
    const handleItemChange = (index: number, field: keyof SalesQuotationItem, value: any) => {
        ...
        if (field === 'productId') {
            ...
            if (product) {
                // FIX: Assign string value directly, not a number.
    ...
    const handleAddItem = () => {
        // FIX: Initialize productId as a string.
        const newItem: SalesQuotationItem = { productId: '', productName: '', quantity: 1, unitPrice: 0, total: 0 };
                ...
                <div className="modal-body">
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', marginBottom: '1.5rem' }}>
                        <div>
                            ...
                            <select value={editableQuote.customerId} onChange={e => handleFieldChange('customerId', e.target.value)} className="form-select">
