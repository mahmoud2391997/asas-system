...
interface InventoryAdjustmentModalProps {
    onClose: () => void;
    onAdjust: (data: { branchId: string; productId: string; newQuantity: number; reason: AdjustmentReason; notes?: string; }) => void;
    branches: Branch[];
    products: Product[];
            ...
            <div className="modal-content glass-pane" style={{ maxWidth: '45rem' }} onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    <div>
                        ...
                        <select value={productId} onChange={e => setProductId(e.target.value)} className="form-select" disabled={!branchId}>
